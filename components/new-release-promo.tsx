        ...
        <div className="relative mx-auto min-h-[500px] sm:min-h-[440px] md:min-h-[480px] lg:min-h-[520px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">DevSphere Apprenticeship Program</h2>
              <p className="text-white/60 mb-8">Learn by building. Get mentorship. Become a leader.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
