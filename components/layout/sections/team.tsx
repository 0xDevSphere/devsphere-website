          ...
          (
            ...
            <Drawer direction="right" key={index}>
              <DrawerTrigger>
                <Card className="bg-muted/60 dark:bg-card flex flex-col h-full overflow-hidden group/hoverimg">
                  <CardHeader className="p-0 gap-0">
                    ...
                    <CardTitle className="py-6 pb-4 px-6 flex justify-start">
                      {firstName}
                  ...
                  {positions.map((position, index) => (
                    <CardContent
                      key={index}
                      className={`pb-0 text-muted-foreground flex justify-start ${
              ...
              <DrawerContent>
                <DrawerHeader>
                  <DrawerClose>
                    <MdOutlineKeyboardDoubleArrowRight className="h-10 w-10 hover:bg-zinc-900 rounded" />
                  </DrawerClose>
                  ...
                  <DrawerDescription>
                    <div className="h-fit flex flex-col items-center overflow-hidden">
                      <Image
                        ...
                        className="w-fit"
                      />
                      <div className="pt-2 flex text-lg justify-start">
                        {firstName}
                        <span className="text-primary ml-2">{lastName}</span>
                      </div>
                      {positions.map((position, index) => (
                        <div
                          key={index}
                          className={`pb-0 text-muted-foreground flex justify-start ${
                            index === positions.length - 1 && "pb-1.5"
                          }`}
                        >
                          {position}
                          {index < positions.length - 1 && <span>,</span>}
                      ...
                      <div className="text-justify p-4">
                        <p>
                          ...
                          elit. Proin lacinia tincidunt venenatis. Proin
                          feugiat, nibh id lobortis sollicitudin, massa mi
                          aliquet lorem, convallis venenatis nisi tortor sed
                          elit. Nullam at tellus vitae quam laoreet imperdiet.
                          Praesent ac imperdiet ante. Donec nec sem dolor. Donec
                          venenatis dui eu eros elementum, sit amet placerat
                          libero interdum.
                        </p>
                      </div>
                    </div>
